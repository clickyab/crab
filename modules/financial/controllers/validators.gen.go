...
func (p *addGatewayPayload) Validate(ctx context.Context, w http.ResponseWriter, r *http.Request) error {
...
func (p *changeCashStatus) Validate(ctx context.Context, w http.ResponseWriter, r *http.Request) error {
	err := func(in interface{}) error {
		if v, ok := in.(interface {
			ValidateExtra(ctx context.Context, w http.ResponseWriter, r *http.Request) error
		}); ok {
	...
	for _, i := range errs.(validator.ValidationErrors) {
		switch i.Field() {
		case "UserID":
			res["user_id"] = trans.E("invalid value")

		case "Reason":
			res["reason"] = trans.E("invalid value")
...
func (p *editGatewayPayload) Validate(ctx context.Context, w http.ResponseWriter, r *http.Request) error {
	err := func(in interface{}) error {
		if v, ok := in.(interface {
			ValidateExtra(ctx context.Context, w http.ResponseWriter, r *http.Request) error
		}); ok {
