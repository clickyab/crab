...
func (p *addUserToWhitelabelPayload) Validate(ctx context.Context, w http.ResponseWriter, r *http.Request) error {
	...
	for _, i := range errs.(validator.ValidationErrors) {
		...
		case "Advantage":
			res["advantage"] = trans.E("should be in 0-99")

		case "CorporationInfo":
			res["corporation_info"] = trans.E("invalid value")
...
func (p *changePass) Validate(ctx context.Context, w http.ResponseWriter, r *http.Request) error {
	err := func(in interface{}) error {
		if v, ok := in.(interface {
			ValidateExtra(ctx context.Context, w http.ResponseWriter, r *http.Request) error
		}); ok {
...
func (p *startImpersonatePayload) Validate(ctx context.Context, w http.ResponseWriter, r *http.Request) error {
	err := func(in interface{}) error {
		if v, ok := in.(interface {
			ValidateExtra(ctx context.Context, w http.ResponseWriter, r *http.Request) error
		}); ok {
