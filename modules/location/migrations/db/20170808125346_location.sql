...
(
  ...
  CONSTRAINT provinces_name_country_id_unidex
...
(
  ...
  CONSTRAINT cities_provinces_id_fk
    FOREIGN KEY (province_id) REFERENCES provinces (id),
  CONSTRAINT cities_name_provinces_id_unidex
    UNIQUE (name,province_id)
);



INSERT INTO countries (id,name) VALUES (1,"ایران");
