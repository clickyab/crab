...
func (c *Controller) Routes(r framework.Mux) {
	once.Do(func() {
		...
		group.GET("controllers-Controller-listCampaigns", "/campaigns", framework.Mix(c.listCampaigns, m4...))
		// End route with key 4

		/* Route {
			"Route": "/campaigns/definition",
			"Method": "GET",
		...
		group.GET("controllers-Controller-defCampaigns", "/campaigns/definition", framework.Mix(c.defCampaigns, m5...))
		...
		group.GET("controllers-Controller-graphChart", "/graph/all", framework.Mix(c.graphChart, m6...))
		...
		m7 = append(m7, authz.AuthorizeGenerator("archive_campaign", "self"))

		group.PATCH("controllers-Controller-archivePatch", "/archive/:id", framework.Mix(c.archivePatch, m7...))
		...
		m8 = append(m8, middleware.PayloadUnMarshallerGenerator(assignInventoryPayload{}))
		group.PUT("controllers-Controller-assignInventoryPut", "/inventory/:id", framework.Mix(c.assignInventoryPut, m8...))
		...
		m9 = append(m9, authz.AuthorizeGenerator("edit_attributes", "self"))

		// Make sure payload is the last middleware
		m9 = append(m9, middleware.PayloadUnMarshallerGenerator(attributesPayload{}))
		group.PUT("controllers-Controller-attributesPut", "/attributes/:id", framework.Mix(c.attributesPut, m9...))
		...
		permission.Register("edit_campaign", "edit_campaign")
		m10 = append(m10, authz.AuthorizeGenerator("edit_campaign", "self"))

		// Make sure payload is the last middleware
		m10 = append(m10, middleware.PayloadUnMarshallerGenerator(campaignBase{}))
		group.PUT("controllers-Controller-updateBasePut", "/base/:id", framework.Mix(c.updateBasePut, m10...))
		...
		m11 = append(m11, authz.AuthorizeGenerator("edit_budget", "self"))

		// Make sure payload is the last middleware
		m11 = append(m11, middleware.PayloadUnMarshallerGenerator(budgetPayload{}))
		group.PUT("controllers-Controller-budgetPut", "/budget/:id", framework.Mix(c.budgetPut, m11...))
		...
		m12 = append(m12, authz.AuthorizeGenerator("change_campaign_status", "self"))

		// Make sure payload is the last middleware
		m12 = append(m12, middleware.PayloadUnMarshallerGenerator(changeCampaignStatus{}))
		group.PATCH("controllers-Controller-changeStatusPatch", "/status/:id", framework.Mix(c.changeStatusPatch, m12...))
		...
		m13 = append(m13, authz.AuthorizeGenerator("copy_campaign", "self"))

		// Make sure payload is the last middleware
		m13 = append(m13, middleware.PayloadUnMarshallerGenerator(copyCampaignPayload{}))
		group.PATCH("controllers-Controller-copyCampaignPatch", "/copy/:id", framework.Mix(c.copyCampaignPatch, m13...))
		...
		// Make sure payload is the last middleware
		m14 = append(m14, middleware.PayloadUnMarshallerGenerator(createCampaignPayload{}))
		group.POST("controllers-Controller-createBasePost", "/create", framework.Mix(c.createBasePost, m14...))
		...
		group.PUT("controllers-Controller-finalizePut", "/finalize/:id", framework.Mix(c.finalizePut, m15...))
		...
		m16 = append(m16, authz.AuthorizeGenerator("get_campaign", "self"))

		group.GET("controllers-Controller-getGet", "/get/:id", framework.Mix(c.getGet, m16...))
		...
		m17 = append(m17, authz.AuthorizeGenerator("get_banner", "self"))

		group.GET("controllers-Controller-getCampaignAdsGet", "/get/:id/ad", framework.Mix(c.getCampaignAdsGet, m17...))
		...
		// Make sure payload is the last middleware
		m19 = append(m19, middleware.PayloadUnMarshallerGenerator(getNativeDataPayload{}))
		group.POST("controllers-Controller-getNativeDataPost", "/native/fetch", framework.Mix(c.getNativeDataPost, m19...))
