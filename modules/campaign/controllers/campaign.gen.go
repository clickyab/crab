...
func (c *Controller) Routes(r framework.Mux) {
	once.Do(func() {
		...
		group.GET("controllers-Controller-graphChart", "/graph/all", framework.Mix(c.graphChart, m2...))
		...
		m3 = append(m3, authz.AuthorizeGenerator("campaign_publisher", "self"))

		group.GET("controllers-Controller-listPublisherdetails", "/publisher-details/:id", framework.Mix(c.listPublisherdetails, m3...))
		...
		group.GET("controllers-Controller-defPublisherdetails", "/publisher-details/:id/definition", framework.Mix(c.defPublisherdetails, m4...))
		...
		m5 = append(m5, authz.AuthorizeGenerator("archive_campaign", "self"))

		group.PATCH("controllers-Controller-archivePatch", "/archive/:id", framework.Mix(c.archivePatch, m5...))
		...
		m6 = append(m6, middleware.PayloadUnMarshallerGenerator(assignInventoryPayload{}))
		group.PUT("controllers-Controller-assignInventoryPut", "/inventory/:id", framework.Mix(c.assignInventoryPut, m6...))
		...
		m7 = append(m7, authz.AuthorizeGenerator("edit_attributes", "self"))

		// Make sure payload is the last middleware
		m7 = append(m7, middleware.PayloadUnMarshallerGenerator(attributesPayload{}))
		group.PUT("controllers-Controller-attributesPut", "/attributes/:id", framework.Mix(c.attributesPut, m7...))
		...
		// Make sure payload is the last middleware
		m8 = append(m8, middleware.PayloadUnMarshallerGenerator(campaignBase{}))
		...
		m9 = append(m9, authz.AuthorizeGenerator("edit_budget", "self"))

		// Make sure payload is the last middleware
		m9 = append(m9, middleware.PayloadUnMarshallerGenerator(budgetPayload{}))
		group.PUT("controllers-Controller-budgetPut", "/budget/:id", framework.Mix(c.budgetPut, m9...))
		...
		m10 = append(m10, authz.AuthorizeGenerator("change_campaign_status", "self"))

		// Make sure payload is the last middleware
		m10 = append(m10, middleware.PayloadUnMarshallerGenerator(changeCampaignStatus{}))
		group.PATCH("controllers-Controller-changeStatusPatch", "/status/:id", framework.Mix(c.changeStatusPatch, m10...))
		...
		m11 = append(m11, authz.AuthorizeGenerator("copy_campaign", "self"))

		// Make sure payload is the last middleware
		m11 = append(m11, middleware.PayloadUnMarshallerGenerator(copyCampaignPayload{}))
		group.PATCH("controllers-Controller-copyCampaignPatch", "/copy/:id", framework.Mix(c.copyCampaignPatch, m11...))
		...
		permission.Register("edit_campaign", "edit_campaign")
		m12 = append(m12, authz.AuthorizeGenerator("edit_campaign", "self"))

		// Make sure payload is the last middleware
		m12 = append(m12, middleware.PayloadUnMarshallerGenerator(createCampaignPayload{}))
		group.POST("controllers-Controller-createBasePost", "/create", framework.Mix(c.createBasePost, m12...))
		...
		group.PUT("controllers-Controller-finalizePut", "/finalize/:id", framework.Mix(c.finalizePut, m13...))
		...
		m14 = append(m14, authz.AuthorizeGenerator("get_campaign", "self"))

		group.GET("controllers-Controller-getGet", "/get/:id", framework.Mix(c.getGet, m14...))
		...
		m15 = append(m15, authz.AuthorizeGenerator("get_banner", "self"))

		group.GET("controllers-Controller-getCampaignAdsGet", "/get/:id/ad", framework.Mix(c.getCampaignAdsGet, m15...))
		...
		// Make sure payload is the last middleware
		m17 = append(m17, middleware.PayloadUnMarshallerGenerator(getNativeDataPayload{}))
