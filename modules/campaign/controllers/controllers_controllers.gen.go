...
//		401 = controller.ErrorResponseSimple
// }
func (c *Controller) updateWhiteBlackListPut(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	pl := c.MustGetPayload(ctx).(*whiteBlackPayload)
	res, err := c.updateWhiteBlackList(ctx, r, pl)
	if err != nil {
		framework.Write(w, err, http.StatusBadRequest)
		return
	}
...
//		401 = controller.ErrorResponseSimple
// }
func (c *Controller) deleteWhiteBlackListDelete(ctx context.Context, w http.ResponseWriter, r *http.Request) {

	res, err := c.deleteWhiteBlackList(ctx, r)
	if err != nil {
		framework.Write(w, err, http.StatusBadRequest)
		return
	}
