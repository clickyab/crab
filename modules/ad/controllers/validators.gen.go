...
func (pl *BannerAssetPayload) Validate(ctx context.Context, w http.ResponseWriter, r *http.Request) error {
	...
	for _, i := range errs.(validator.ValidationErrors) {
		...
		case "VideoImage":
			res["video_image"] = trans.E("invalid value")

		case "Video":
			res["video"] = trans.E("invalid value")

		case "BannerImage":
			res["banner_image"] = trans.E("invalid value")
...
func (pl *CreateBannerCreative) Validate(ctx context.Context, w http.ResponseWriter, r *http.Request) error {
	err := func(in interface{}) error {
		if v, ok := in.(interface {
			ValidateExtra(ctx context.Context, w http.ResponseWriter, r *http.Request) error
		}); ok {
...
func (p *createBannerPayload) Validate(ctx context.Context, w http.ResponseWriter, r *http.Request) error {
	...
	for _, i := range errs.(validator.ValidationErrors) {
		...
		case "Creative":
			res["creative"] = trans.E("invalid value")

		case "Type":
			res["banner_type"] = trans.E("invalid value")
