...
func validateVastMedia(image string) (*uploadOrm.Upload, orm.AssetTypes, error) {
	...
	if uploadFile.Attr.Video == nil {
		return nil, orm.AssetVideoType, errors.InvalidVideoSize
	}
	...
	if uploadFile.Attr.Banner == nil {
		return nil, orm.AssetImageType, errors.InvalidImageSize
	}
...
func generateVastString(asset orm.VastString, typ orm.AssetTypes, key string) *orm.Asset {
	tmp := map[string]interface{}{
