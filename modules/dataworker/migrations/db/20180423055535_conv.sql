...
DROP TABLE IF EXISTS `impression_details`;
...
(
  ...
  seat_id VARCHAR(63) NOT NULL,
  created_at TIMESTAMP NOT NULL,
  CONSTRAINT conversions_created_at_id_pk PRIMARY KEY (created_at, id)
);
...
DROP TABLE conversion_details;
DROP TABLE conversions;
DROP TABLE click_details;
DROP TABLE clicks;
